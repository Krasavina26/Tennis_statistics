...
*Уточнение: последний датасет вообще содержит 4 класса вместо 2. Помимо сетки и игроков размечены мяч и ракетки, однако общее число кадров слишком мало для качественного обучения таких мелких объектов, поэтому невозможно обучить качественно определять ограничивающие рамки мяча и ракеток по этому датасету.*
